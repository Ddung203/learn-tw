    ...
    <form action="" method="post">
        <div class="grid grid-cols-6 gap-5 bg-gray-100 px-4  py-5">
            ...
            <input type="checkbox" name="" id="" class="w-[18px] h-[18px] font-thin mr-3">
                ...
                <!-- San pham -->
                <?php include_once("../pages/userFunction/userList.php"); ?>
            ...
            <div class="col-span-2 bg-gray-100 mt-[48px]">
                ...
                <!-- Giao tới -->
                <?php include_once("../pages/userFunction/userAddress.php"); ?>

                <!-- Tiki Khuyen mai -->
                <?php include_once("../pages/userFunction/userVoucher.php"); ?>

                <!-- Thanh toán -->
                <?php include_once("../pages/userFunction/userPay.php"); ?>
