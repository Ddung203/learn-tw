...
if ($number_of_result > 0) {
  echo "<div class=\"grid grid-cols-4 mt-2 gap-2\">";
  while ($result = mysqli_fetch_assoc($query)) {
    echo
    "  <a href='product.php?ProductID=" . $result['ProductID'] .  " ' class=\"bg-white\">
                    <!-- img -->
                    <div class=\"relative\">
                      <img src=\"https://salt.tikicdn.com/ts/upload/f0/68/87/8b851bd4e439a34de96a6152cffcd1b3.png\" alt=\"\" class=\"absolute w-[72px] h-[20px]\" />
                      <img src=\"../../Uploads/" . $result['Image'] . "\" alt=\"\" class=\"h-full w-full py-2 px-3 \" />
                    </div>
      ...
      $result["ProductName"] . "
                      ...
                      <div class=\"flex mb-[6px] items-center\">
                        <div class=\"flex items-center gap-1\">
                          <span class=\"text-[12px] text-[#808089]\"> " . $result["Star"] . " </span>
                          <svg class='w-3 h-3 none' aria-hidden=\"true\" xmlns=\"http://www.w3.org/2000/svg\" fill=\"currentColor\" viewBox=\"0 0 22 20\">
                            <path d=\"M20.924 7.625a1.523 1.523 0 0 0-1.238-1.044l-5.051-.734-2.259-4.577a1.534 1.534 0 0 0-2.752 0L7.365 5.847l-5.051.734A1.535 1.535 0 0 0 1.463 9.2l3.656 3.563-.863 5.031a1.532 1.532 0 0 0 2.226 1.616L11 17.033l4.518 2.375a1.534 1.534 0 0 0 2.226-1.617l-.863-5.03L20.537 9.2a1.523 1.523 0 0 0 .387-1.575Z\" />
                          </svg>
                        </div>
                        <div class=\"w-[1px] h-[14px] bg-gray-100 ml-[2px] mr-[4px]\"></div>
                        <div class=\"flex items-center\">
                          <span class=\"text-[12px] none text-[#808089]\">Đã bán " .  convertSoldOut($result["sellNumber"]) . "</span>
                        </div>
                      </div>
  ...
  // <!-- Kết thúc product -->
  include_once "./../includes/cuong/Filter/Pagination.php";
} else echo "
