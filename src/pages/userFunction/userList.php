...
$sql = "SELECT Image, ProductName, Price, OldPrice, CartID, cart.ProductID, SoLuongMua  FROM cart INNER JOIN products ON cart.ProductID = products.ProductID WHERE UserID = $id ";
    ...
    <div class="w-full flex items-center px-[16px] py-[9px] gap bg-white rounded-md ">
        ...
        <div class="w-[35%] h-32 flex">
            <div class="w-[50%] flex justify-center items-center">
                <img src="../../../Uploads/<?php echo $row["Image"] ?>" alt="" class="block">
            </div>
        ...
        <div class="text-[14px] w-[20%] leading-5 flex items-center gap-[5px]">
            <div class="font-medium ">
                <span id="price_<?php echo $row["CartID"] ?>"><?php echo $row["Price"] ?></span>
            </div>
            <div class="text-gray-500 font-light text-xs">
                <span><s><?php echo $row["OldPrice"] ?> <u>đ</u></s></span>
            </div>
        </div>
        ...
        <div class="text-[14px] w-[15%]">
            <span class="text-red-400 font-medium ">
                <span class="product-price" data-product-id="<?php echo $row["CartID"] ?>">
                    <?php echo $row["Price"] * $row["SoLuongMua"] ?>
                </span>
        </div>
