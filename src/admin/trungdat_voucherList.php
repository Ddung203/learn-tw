                ...
                <ul class="feature flex flex-col">
                    ...
                    <li class="nav-item flex w-full  flex-col">
                        ...
                        <ul class="nav nav-treeview" style="display: block;">
                            ...
                            <li class="nav-item w-full rounded-md flex gap-2 px-[16px] py-[8px] text-[#c2c7d0] items-center hover:bg-[#494e53]">
                                <a href="../../../src/admin/trungdat_voucherFix.php" class="nav-link flex items-center justify-center gap-[10px] pl-4">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Thêm Voucher</p>
                                </a>
                            </li>
                            ...
                            <li class="nav-item w-full rounded-md flex gap-2 px-[16px] py-[8px] text-[#c2c7d0] items-center hover:bg-[#494e53]">
                                <a href="../../../src/admin/trungdat_voucherDelete.php" class="nav-link flex items-center justify-center gap-[10px] pl-4">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Xóa Voucher</p>
                                </a>
                            </li>
